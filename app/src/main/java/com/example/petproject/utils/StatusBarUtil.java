...
public class StatusBarUtil {
    ...
    public static void immersive(
            Activity activity, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
...
//        window.setStatusBarColor(Color.TRANSPARENT);
     ...
     * 创建假的透明栏
     */
    public static void setTranslucentView(
            ViewGroup container, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
